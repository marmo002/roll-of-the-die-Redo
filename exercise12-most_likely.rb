...
maxNumb = total_times.values.max
percent = (maxNumb.to_f / total_permutations) * 100
numb = total_times.key(maxNumb)

puts "#{numb} is the most likely to come up with a #{percent.round}% chance"
